(()=>{"use strict";class e{constructor(e,t){window.addEventListener("popstate",(e=>this.route())),this._routes=e,this._defaultRoute=t,this._actualRoute=""}getActualRoute(){return this._actualRoute}route(){let e=!1;const t=window.location.hash;for(const[s,r]of Object.entries(this._routes))if("#"+s==t){this._actualRoute=s,r.init()&&(e=!0);break}e||this.routeDefault()}routeTo(e){let t=!1;for(const[s,r]of Object.entries(this._routes))s==e&&(t=!0);t?(this._actualRoute=e,window.location.hash="#"+e,this._routes[e].init()):console.log("route %s does not exist",e)}routeDefault(){this._actualRoute=this._defaultRoute.name,window.location.hash="#"+this._defaultRoute.name,this._defaultRoute.control.init()}}class t{constructor(e,t){this.name=e,this.storedClasses={},this.data=[],t.forEach((e=>{this.storedClasses[e.name]=e}))}getData(){return this.data}load(){let e=window.localStorage.getItem(this.name);null==e?this.save():this.data=JSON.parse(e,((e,t)=>{if("object"==typeof t&&"_class"in t){let e=new this.storedClasses[t._class];return Object.assign(e,t)}return t}))}save(){window.localStorage.setItem(this.name,JSON.stringify(this.data))}}class s{constructor(e){this._app=e}init(){return!0}}class r{constructor(){this._navEl=document.querySelector("header nav"),this._userEl=document.getElementById("user"),this._user=""}init(e){this._navEl.innerHTML=this._nav(e),this._userEl.innerHTML=this._user}_nav(e){return String.raw`
        ...
        `}}class E extends l{constructor(){super(),this.email="",this.passwordHash="",this.notes=[],this.diaryNotes=[],this.style="blue"}async doesPasswordMatch(e){let t=await b(e);return this.passwordHash==t}static async createWithPassword(e,t){let s=new E;return s.email=e,s.passwordHash=await b(t),s}static isEmailIncorrect(e){return e.indexOf("@")>-1&&e.indexOf(".")>-1?e.indexOf("@")>0&&e.indexOf(".")>e.indexOf("@")+1&&e.indexOf(".")<e.length-1?"":"Incorrect email.":"Missing @ or . in the email."}static isPasswordIncorrect(e){return e.length<=3?"Password must be longer than 3 characters.":""}}async function b(e){const t=(new TextEncoder).encode(e),s=await crypto.subtle.digest("SHA-256",t).then();return Array.from(new Uint8Array(s)).map((e=>e.toString(16).padStart(2,"0"))).join("")}class f extends n{constructor(e){super(e),this._view=new v}init(){let e=super.init();return e&&(this._view.init(),this._view.getForm().addEventListener("submit",(e=>{e.preventDefault(),this._submitForm()})),this._view.getEmailInput().addEventListener("keyup",(e=>{e.preventDefault(),this._validateEmail()})),this._view.getPassword1Input().addEventListener("blur",(e=>{e.preventDefault(),this._validatePassword1()})),this._view.getPassword2Input().addEventListener("blur",(e=>{e.preventDefault(),this._validatePassword2()}))),e}_submitForm(){if(this._validatePassword2()&&this._validatePassword1()&&this._validateEmail()){let e=this._view.getEmailInput().value,t=this._view.getPassword1Input().value,s=this._app.getUsers();E.createWithPassword(e,t).then((e=>{s.getData().push(e),s.save(),this._app.user=e,this._app.router.routeTo("diary")}))}}_validateEmail(){this._view.clearErrors();let e=this._view.getEmailInput().value,t=E.isEmailIncorrect(e);return t?(this._view.setEmailError(t),!1):!this._isRegistered(e)||(this._view.setEmailError("Such a user already exists."),!1)}_validatePassword1(){this._view.clearErrors();let e=this._view.getPassword1Input().value,t=E.isPasswordIncorrect(e);return!t||(this._view.setPassword1Error(t),!1)}_validatePassword2(){return this._view.clearErrors(),this._view.getPassword1Input().value==this._view.getPassword2Input().value||(this._view.setPassword2Error("Passwords do not match."),!1)}_isRegistered(e){let t=this._app.getUsers().getData(),s=!1;return t.forEach((t=>{t.email==e&&(s=!0)})),s}}class D{constructor(){this._navEl=document.querySelector("header nav"),this._userEl=document.getElementById("user"),this._emailEl=null}init(e,t){this._navEl.innerHTML=this._nav(e),this._userEl.innerHTML=this._user(e),this._emailEl=document.getElementById("loggedInUserEmail"),this._emailEl.textContent=t}_nav(e){return String.raw`
            <ul>
                <li>
        ...
        `}}class P extends S{constructor(e){super(e),this._view=new T}init(){let e=super.init();return e&&(this._view.init(this._app.user.style),this._view.getForm().addEventListener("submit",(e=>{e.preventDefault(),this._submitForm()}))),e}_submitForm(){let e=this._view.getForm(),t=this._app.user,s=new FormData(e);t.style=s.get("style"),this._app._users.save(),a(t.style)}}class C extends l{constructor(){super(),this.name="",this.description=""}static createNote(e,t){let s=new C;return s.name=e,s.description=t,s}static isNameIncorrect(e){return e.length>100?"The name is too long.":e.length<1?"The name must be at least one character.":""}static isDescriptionIncorrect(e){return e.length>2e4?"The description is too long.":""}}new class{constructor(){let s={main:new y(this),login:new w(this),register:new f(this),diary:new L(this),logout:new M(this),changeStyle:new P(this)},r={name:"main",control:s.main};this.router=new e(s,r),this.router.route(),this._users=new t("diary-js-users",[E,h,C,F]),this._users.load(),this.user=null}getUsers(){return this._users}}})();
